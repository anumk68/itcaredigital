                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                @if($brand->banner_image)
                                    <div class="mb-2">
                                        <img src="{{ asset('storage/' . $brand->banner_image) }}" alt="Banner" width="100">
                                    </div>
                                @endif
                            ...
                            <div class="col-md-6">
                                ...
                                @if($brand->icon_image)
                                    <div class="mb-2">
                                        <img src="{{ asset('storage/' . $brand->icon_image) }}" alt="Icon" width="40">
                                    </div>
                                @endif
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                @if($brand->additional_image)
                                    <div class="mb-2">
                                        <img src="{{ asset('storage/' . $brand->additional_image) }}" alt="Additional" width="100">
                                    </div>
                                @endif
