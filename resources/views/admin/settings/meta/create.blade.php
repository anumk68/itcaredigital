		...
		<div class="page-wrapper">
			<div class="page-content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="add_form" class="form-horizontal" action="{{ route('meta.create.post') }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-md-9">
                                    <input type="text" placeholder="Description" id="page" name="description" class="form-control" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-md-9">
                                    <textarea name="faq_schema" rows="5" class="form-control"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-md-9">
                                    <textarea name="extra_schema" rows="5" class="form-control"></textarea>
                                </div>
                            </div>
