                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{ route('user.view', $item->id) }}" class="btn btn-info btn-sm">View</a>
                                <form action="{{ route('user.delete', $item->id) }}" method="POST" class ="delete-form" style="display:inline;">
                                    @csrf
                                    @method('DELETE')
