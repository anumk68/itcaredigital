    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form id="add_form" class="form-horizontal" action="{{ route('vlog.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group mb-2 row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="Vlog Title" onkeyup="makeSlug(this.value)" id="title" name="title" class="form-control" minlength="10" required value="{{ old('title') }}">
                    ...
                    <div class="form-group mb-2 row">
                        ...
                        <div class="col-md-9">
                            <input type="text" placeholder="Slug" name="slug" id="slug" class="form-control" required value="{{ old('slug') }}">
                    ...
                    <div class="form-group mb-2 row">
                        ...
                        <div class="col-md-9">
                            <input type="url" placeholder="https://www.youtube.com/watch?v=..." name="video_url" class="form-control" required value="{{ old('video_url') }}">
                    ...
                    <div class="form-group mb-2 row">
                        ...
                        <div class="col-md-9">
                            ...
                            @error('meta_img') <span class="text-danger">{{ $message }}</span> @enderror
                        </div>
                    </div>
