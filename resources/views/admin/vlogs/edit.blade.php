...
@section('content')
    <div class="page-wrapper">
        <div class="page-content">
            ...
            <div class="card">
                <div class="card-body">
                    <form id="edit_form" class="form-horizontal" action="{{ route('vlog.update', $vlog->id) }}"
                        ...
                        <div class="form-group mb-2 row">
                            ...
                            <div class="col-md-9">
                                <input type="text" placeholder="Vlog Title" onkeyup="makeSlug(this.value)" id="title"
                                    name="title" class="form-control" value="{{ $vlog->title }}" minlength="10" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-2 row">
                            ...
                            <div class="col-md-9">
                                <input type="url"
                                    ...
                                    name="blog_link" class="form-control" required value="{{ $vlog->blog_link }}">
                                @error('blog_link')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                                ...
                                <select class="form-control aiz-selectpicker" name="category_id" id="category_id"
                                    ...
                                    @foreach ($vlog_categories as $category)
                                        <option value="{{ $category->id }}"
                                            {{ $vlog->category_id == $category->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group mb-2 row">
                            ...
                            <div class="col-md-9">
                                <input type="url" placeholder="https://www.youtube.com/watch?v=..." name="video_url"
                                    class="form-control" value="{{ $vlog->video_url }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group mb-2 row">
                            ...
                            <div class="col-md-9">
                                ...
                                @if ($vlog->meta_img)
                                    <img src="{{ asset($vlog->meta_img) }}" alt="Meta Image" width="100"
                                        class="mt-2">
                                @endif
                            </div>
                        </div>
