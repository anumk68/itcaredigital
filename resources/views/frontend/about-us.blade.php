                ...
                <div class="col-lg-6">
                    <div class="about-us-thumb">
                        <div class="about-us-img">
                            <img src="{{ asset('public/frontend/assets/images/inner/about-us-thu.png') }}" alt="thumb">
                        </div>
                      ...
                      <a class="video-vemo-icon venobox vbox-item" data-vbtype="youtube" data-autoplay="true" href="https://www.youtube.com/watch?v=Wx48y_fOfiY"><i class="bi bi-play"></i><span>WATCH VIDEO</span></a>
                        ...
                        <div class="about-us-shape">
                            <img src="{{ asset('public/frontend/assets/images/inner/us-shape.png') }}" alt="shape">
                        </div>
                    </div>
                </div>
            </div>
            <div class="about2-us-shape">
                <img src="{{ asset('public/frontend/assets/images/inner/about-us-sh.png') }}" alt="shape">
            </div>
            <div class="about-us-shape2">
                <img src="{{ asset('public/frontend/assets/images/inner/about-us-she.png') }}" alt="shape">
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-box">
                        <div class="single-blog-thumb">
                            <img src="{{ asset('public/frontend/assets/images/home-two/blog-thu.png') }}" alt="thumb">
                        ...
                        <div class="blog-box-content">
                            <div class="meta-blog">
                                <a href="{{ route('blog') }}"><span><i class="far fa-user"></i>HOSSAIN ASIF</span></a>
                                <p><span><img src="{{ asset('public/frontend/assets/images/home-two/mesage-icon.png') }}"
                                            alt="icon"></span>COMMENTS</p>
                            </div>
                            <h3><a href="{{ route('blog') }}">Regional Manager limited time
                                    management.
                                </a></h3>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-blog-box">
                        ...
                        <div class="blog-box-content">
                            ...
                            <h3><a href="{{ route('blog') }}">The Complete Guide to Tekone
                                    App Development
                                </a></h3>
                            <div class="blog-button">
                                <a class="btn-2" href="{{ route('blog') }}">read post</a>
