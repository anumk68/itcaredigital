...
@php
    $metaTitle = $brand->meta_title ?? ($brand->name ?? '');
    $metaDescription = $brand->meta_description ?? 'Learn more about our brands.';
    $metaKeywords = $brand->meta_keyword ?? 'default, service, keywords';
@endphp
...
@section('content')
    @php
        if ($brand->banner_image) {
            $bannerImage = asset('storage/app/public/' . $brand->banner_image);
        } else {
            $bannerImage = asset('public/images/about_bannner.png');
        }
    @endphp
                    ...
                    <div class="col-md-3">
                        <a href="{{ route('service_detail', ['brand_slug' => $brand->slug, 'service_slug' => $service->slug]) }}"
                            ...
                            <div class="issue-box">
                                ...
                                <div class="services_main_under">{{ $service->service_name }}</div>
                            </div>
                        </a>
                    </div>
                @endforeach
    ...
    <section class="why_choose_us py_8 pb-0">
        <div class="container">
                ...
                <div class="col-md-6 mb-3">
                    <div class="content-box">
                        ...
                        <p class="section-content">
                            {!! $brand->seo_content ??
                                'We provide comprehensive solutions for all your printer issues, ensuring smooth and efficient printing experiences. Our expert team is dedicated to resolving any problems you may encounter with your printer, from setup and installation to troubleshooting and maintenance.' !!}
                        </p>
    ...
    <section class="blog-section py_8">
        <div class="container">
            <h2 class="section-title mb-4">Latest {{ ucwords(str_replace('-', ' ', $brand_slug)) }} Printer Blogs And
                Drivers</h2>
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <div class="products">
                        <div class="main_print_form">
                            ...
                            <img class="lazyload" src="{{ asset('public/images/about/fill_out_form_img.webp') }}"
                                alt="printing_form">
                        </div>
                    </div>
                </div>
