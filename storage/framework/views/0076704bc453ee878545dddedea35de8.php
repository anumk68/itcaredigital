  ...
  <div class="container-fluid">
    <div class="row align-items-center">
      ...
      <div class="col-lg-2 col-6">
        <div class="logo">
          <a href="<?php echo e(route('home')); ?>" class="logo_img">
            <img src="<?php echo e(asset('public/frontend/assets/images/Artboard 1It care digital.png')); ?>" alt="logo" class="img-fluid">
          </a>
        </div>
      </div>
          ...
          <ul class="nav_scroll">
            ...
            <li>
              ...
              <ul class="sub-menu">
                ...
                <li><a href="<?php echo e(route('digital-content-marketing')); ?>">Digital Content Marketing</a></li>
      ...
      <div class="col-lg-2 d-none d-lg-block text-end">
        <div class="header-btn">
          <a href="<?php echo e(route('contact')); ?>" class="btn-quote">Get A Quote NOW <i class="bi bi-arrow-right"></i></a>
        </div>
      </div>
  ...
  <div class="mobile-menu-inner">
    ...
    <div class="mobile-logo d-flex justify-content-between align-items-center px-3 py-2" style="background:#0a0f2c;">
      <a href="<?php echo e(route('home')); ?>">
        <img src="<?php echo e(asset('public/frontend/assets/images/logo_white.png')); ?>" alt="Itcare" width="140">
      </a>
      <!-- Toggle Button -->
...
</script><?php /**PATH C:\xampp\htdocs\ITcaredigital_29oct\SendAnywhere_085453\itCareDigital_For_SEO_Chnages_From_Mamta\itCareDigital_For_SEO_Chnages_From_Mamta\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>