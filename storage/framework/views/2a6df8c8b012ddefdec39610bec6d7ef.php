                ...
                <div class="feature-box">
                    <div class="feature-sinble-single-box">
                        <div class="feature-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/SEO.svg')); ?>"
                    ...
                    <div class="feature-sinble-single-box">
                        <div class="feature-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/ppc.svg')); ?>"
                    ...
                    <div class="feature-sinble-single-box">
                        <div class="feature-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/web development.svg')); ?>"
                                alt="digital marketing agency usa">
                        </div>
                        <div class="feature-content">
                    ...
                    <div class="feature-sinble-single-box">
                        <div class="feature-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/web design .svg')); ?>"
                                alt="website design and development company">
                        </div>
                        <div class="feature-content">
                    ...
                    <div class="feature-sinble-single-box">
                        <div class="feature-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/social media marketing .svg')); ?>"
                                alt="affordable marketing services usa">
                        </div>
                        <div class="feature-content">
        ...
        <div class="container">
            <div class="row align-items-center d-flex align-items-stretch">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3 d-flex">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/search-engine optimization .svg')); ?>"
                                alt="custom seo and web design">
                        </div>
                        <div class="service-content">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3 d-flex">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/ppc management .svg')); ?>"
                                alt="affordable marketing services usa">
                        </div>
                        <div class="service-content">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3 d-flex">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/social-marketing.svg')); ?>"
                                alt="digital marketing agency usa">
                        </div>
                        <div class="service-content">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3 d-flex">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/digital marketing .svg')); ?>"
                                alt="website design and development company">
                        </div>
                        <div class="service-content">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3 d-flex">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/e commerce seo .svg')); ?>"
                                alt="affordable marketing services usa">
                        </div>
                        <div class="service-content">
                    ...
                    <div class="testi_list owl-carousel">
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="testi-box">
                                ...
                                <div class="testi-author">
                                    <img src="<?php echo e(asset('public/frontend/assets/images/80.png')); ?>"
                                        alt="affordable marketing services usa">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="testi-box">
                                ...
                                <div class="testi-author" style = "border-radius: 50%">
                                    <img src="<?php echo e(asset('public/frontend/assets/images/80 (1).png')); ?>"
                                        alt="website design and development company">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog-box">
                            ...
                            <div class="blog-box-content">
                                ...
                                <p><a href="<?php echo e(route('blog')); ?>"><?php echo e($blog->short_description); ?>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\ITcaredigital_29oct\resources\views/frontend/index.blade.php ENDPATH**/ ?>