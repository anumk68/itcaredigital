        ...
        <nav class="solutek_menu">
            <ul class="nav_scroll">
                ...
                <li><a href="#">Digital Marketing <i class="bi bi-chevron-down"></i></a>
                  ...
                  <li><a href="#">Web Services <i class="bi bi-chevron-down"></i></a>
                    <ul class="sub-menu">
                          <li><a href="<?php echo e(route('web-design')); ?>">web Design</a>
                                </li>
                                <li><a href="<?php echo e(route('web-development')); ?>">Web Development</a></li>
...
<!--==================================================-->
<?php /**PATH C:\xampp\htdocs\151025itcaredigital\itcaredigitalforadmin_backend\itcaredigitalforadmin_backend\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>