<?php $__env->startSection('title', 'Social Media Marketing Services in USA | Affordable SMM Agency - IT Care Digital'); ?>
<?php $__env->startSection('meta_description',
    'Grow your brand presence with our social media marketing services in the USA. Affordable
    packages for Facebook, Instagram, LinkedIn, and more.'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="about-us-area">
        <div class="container">
                ...
                <div class="col-lg-6">
                    <div class="about-us-thumb">
                        <div class="about-us-img">
                            <img src="<?php echo e(asset('public/frontend/assets/images/inner/hand-holding-smartphone-social-media-concept_23-2150208260.jpg')); ?>"
            ...
            <div class="about2-us-shape">
                <img src="<?php echo e(asset('public/frontend/assets/images/inner/about-us-sh.png')); ?>" alt="affordable smm packages">
            </div>
        ...
        <div class="container">
            <div class="row align-items-center d-flex align-items-stretch">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3 d-flex">
                    <div class="single-service-box">
                        <div class="service-thumb">
                            <img src="<?php echo e(asset('public/frontend/assets/images/inner/social_1.jpg')); ?>"
                                alt="digital branding agency">
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3 d-flex">
                    <div class="single-service-box">
                        <div class="service-thumb">
                            <img src="<?php echo e(asset('public/frontend/assets/images/inner/social_2.jpg')); ?>"
                                alt="social media marketing company usa">
                        </div>
                        <!-- <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/inner/service-icon.png')); ?>"
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3 d-flex">
                    <div class="single-service-box">
                        <div class="service-thumb">
                            <img src="<?php echo e(asset('public/frontend/assets/images/inner/social_3.jpg')); ?>"
                                alt="affordable smm packages">
                        </div>
                        <!-- <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/inner/service-icon.png')); ?>"
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3 d-flex">
                    <div class="single-service-box">
                        <div class="service-thumb">
                            <img src="<?php echo e(asset('public/frontend/assets/images/inner/social_4.jpg')); ?>"
                                alt="social media ad management">
                        </div>
                        <!-- <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/inner/service-icon.png')); ?>"
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3 d-flex">
                    <div class="single-service-box">
                        <div class="service-thumb">
                            <img src="<?php echo e(asset('public/frontend/assets/images/inner/social_5.jpg')); ?>"
                                alt="digital branding agency">
                        </div>
                        <!-- <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/inner/service-icon.png')); ?>"
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3 d-flex">
                    <div class="single-service-box">
                        <div class="service-thumb">
                            <img src="<?php echo e(asset('public/frontend/assets/images/inner/social_6.jpg')); ?>"
                                alt="social media marketing company usa">
                        </div>
                        <!-- <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/inner/service-icon.png')); ?>"
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3 d-flex">
                    <div class="single-service-box">
                        <div class="service-thumb">
                            <img src="<?php echo e(asset('public/frontend/assets/images/inner/social_7.jpg')); ?>"
                                alt="affordable smm packages">
                        </div>
                        <!-- <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/inner/service-icon.png')); ?>"
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3 d-flex">
                    <div class="single-service-box">
                        <div class="service-thumb">
                            <img src="<?php echo e(asset('public/frontend/assets/images/inner/social_8.jpg')); ?>"
                                alt="social media ad management">
                        </div>
                        <!-- <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/inner/service-icon.png')); ?>"
            ...
            <div class="service-shape bounce-animate3">
                <img src="<?php echo e(asset('public/frontend/assets/images/service5.png')); ?>" alt="digital branding agency">
            </div>
            <div class="service-shape2">
                <img src="<?php echo e(asset('public/frontend/assets/images/service7.png')); ?>" alt="social media ad management">
            </div>
            <div class="service-shape3 bounce-animate4">
                <img src="<?php echo e(asset('public/frontend/assets/images/service8.png')); ?>" alt="affordable smm packages">
            </div>
        </div>
    </div>
    ...
    <div class="faq-area">
        <div class="container">
            ...
            <div class="faq-shape">
                <img src="<?php echo e(asset('public/frontend/assets/images/faq2.png')); ?>" alt="digital branding agency">
            </div>
            <div class="faq-shape2">
                <img src="<?php echo e(asset('public/frontend/assets/images/faq3.png')); ?>" alt="social media ad management">
            </div>
        </div>
    </div>
