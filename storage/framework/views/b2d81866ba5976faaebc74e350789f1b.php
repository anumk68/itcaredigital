            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="section-title text-left">
                        ...
                        <h1 class="section-main-title">Powerful Digital Marketing Solutions</h1>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="section-title text-center">
                        ...
                        <h1 class="section-main-title">Empower Your Business Growth </h1>
                        <h1 class="section-main-title">with Smart <span>Digital Solutions.</span></h1>
                    </div>
                </div>
            ...
            <div class="row project align-items-center">
                <div class="col-lg-6">
                    <div class="section-title text-left">
                        ...
                        <h1 class="section-main-title">Explore Our Recent <span>Services.</span></h1>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="project-right">
                        <!-- <div class="solutek-btn">
                                <a href="#">VIEW PROJECT DETAIL
                                    <div class="solutek-hover-btn hover-bx"></div>
                                    <div class="solutek-hover-btn hover-bx2"></div>
                                    <div class="solutek-hover-btn hover-bx3"></div>
                                    <div class="solutek-hover-btn hover-bx4"></div>
            ...
            <div class="row carousel">
                <div class="project_list owl-carousel">
                    <div class="col-lg-12 col-md-12">
                        <div class="project-single-box">
                            <div class="project-thumb">
                                <img src="<?php echo e(asset('public/frontend/assets/images/project1.png')); ?>" alt="project1">
                            </div>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="project-single-box">
                            <div class="project-thumb">
                                <img src="<?php echo e(asset('public/frontend/assets/images/project2.png')); ?>" alt="project1">
                            </div>
                            <div class="project-content">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="project-single-box">
                            <div class="project-thumb">
                                <img src="<?php echo e(asset('public/frontend/assets/images/project3.png')); ?>" alt="project1">
                            </div>
                            <div class="project-content">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="project-single-box">
                            <div class="project-thumb">
                                <img src="<?php echo e(asset('public/frontend/assets/images/project4.png')); ?>" alt="project1">
                            </div>
                            <div class="project-content">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="project-single-box">
                            <div class="project-thumb">
                                <img src="<?php echo e(asset('public/frontend/assets/images/project5.png')); ?>" alt="project1">
                            </div>
                            <div class="project-content">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="project-single-box">
                            ...
                            <div class="project-content">
                                <h3 class="project-title"><a href="#">App Development</a>
                                </h3>
                                <p class="project-text">Software</p>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="section-title text-center">
                        ...
                        <h1 class="section-main-title2">How IT Care Digital Works in 3 Simple Steps</h1>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="section-title text-left">
                        ...
                        <h1 class="section-main-title">About IT <span>Care Digital Services.</span></h1>
                    </div>
                    <div class="faq-thumb">
                    ...
                    <div class="contact-box">
                        <div class="contact-video-icon">
                            <a class="video-vemo-icon venobox vbox-item" data-vbtype="youtube" data-autoplay="true"
                                href="https://www.youtube.com/watch?v=Wx48y_fOfiY">Play</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\itcaredigitalforadmin_backend\resources\views/frontend/index.blade.php ENDPATH**/ ?>