<?php $__env->startSection('title', 'IT Care Digital | Digital Marketing Experts'); ?>
<?php $__env->startSection('meta_description',
    'Boost your business with SEO, PPC, web design, social media, and content marketing. IT
    Care Digital delivers results-driven strategies for growth.'); ?>
            ...
            <div class="row hero align-items-center">
                <div class="col-lg-6">
                    <div class="hero-contant">
                        ...
                        <h1>The Power Behind Digital Marketing</h1>
                   
                        <p>Grow your brand with strategies that bring real results. We help businesses connect with their
                            audience through data-driven digital marketing solutions built to perform.</p>
                        <div class="solutek-btn">
                            <a href="<?php echo e(route('contact')); ?>">Learn MORE
                ...
                <div class="col-lg-6">
                    <div class="hero-thumb">
                        <img src="<?php echo e(asset('public/frontend/assets/images/hero-thumb.png')); ?>" alt="hero-thumb">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="feature-box">
                    <div class="feature-sinble-single-box">
                        <div class="feature-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/feature1.png')); ?>" alt="feature1">
                        </div>
                        <div class="feature-content">
                            <h3 class="feature-title">SEO</h3>
                    ...
                    <div class="feature-sinble-single-box">
                        <div class="feature-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/feature2.png')); ?>" alt="feature1">
                        </div>
                        <div class="feature-content">
                            <h3 class="feature-title">PPC</h3>
                    ...
                    <div class="feature-sinble-single-box">
                        <div class="feature-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/feature3.png')); ?>" alt="feature1">
                        </div>
                        <div class="feature-content">
                    ...
                    <div class="feature-sinble-single-box">
                        <div class="feature-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/feature4.png')); ?>" alt="feature1">
                        </div>
                        <div class="feature-content">
                    ...
                    <div class="feature-sinble-single-box">
                        <div class="feature-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/feature5.png')); ?>" alt="feature1">
                        </div>
                        <div class="feature-content">
                            <h3 class="feature-title">Social Media Marketing</h3>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-lg-6">
                    <div class="about-thumb">
                        <img src="<?php echo e(asset('public/frontend/assets/images/about-thumb.png')); ?>" alt="about-thumb">
                        <div class="about-shape">
                            <img src="<?php echo e(asset('public/frontend/assets/images/about1.png')); ?>" alt="about1">
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="section-title text-left">
                        ...
                        <h2 class="section-main-title">Powerful Digital Marketing Solutions <span> Modern Businesses.</span></h2>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <div class="section-title text-center">
                        ...
                        <h2 class="section-main-title">Empower Your Business Growth with <br> Smart <span>Digital Solutions.</span> </h2>
                        <h2 class="section-main-title"></h2>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/service1.png')); ?>" alt="service1">
                        </div>
                        <div class="service-content">
                            ...
                            <div class="service-btn">
                                <a href="<?php echo e(route('web-development')); ?>"><i class="fas fa-plus"></i> READ MORE</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/service2.png')); ?>" alt="service1">
                        </div>
                        <div class="service-content">
                            ...
                            <div class="service-btn">
                                <a href="<?php echo e(route('web-design')); ?>"><i class="fas fa-plus"></i> READ MORE</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/service3.png')); ?>" alt="service1">
                        </div>
                        <div class="service-content">
                            ...
                            <div class="service-btn">
                                <a href="<?php echo e(route('search-engine-optimization')); ?>"><i class="fas fa-plus"></i> READ MORE</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/service4.png')); ?>" alt="service1">
                        </div>
                        <div class="service-content">
                            ...
                            <div class="service-btn">
                                <a href="<?php echo e(route('ppc-services')); ?>"><i class="fas fa-plus"></i> READ MORE</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/e-commerce seo icon.png')); ?>" alt="service1">
                        </div>
                        <div class="service-content">
                            ...
                            <div class="service-btn">
                                <a href="<?php echo e(route('social-media-marketing')); ?>"><i class="fas fa-plus"></i> READ MORE</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/digital marketing2 (1).png')); ?>" alt="service1">
                        </div>
                        <div class="service-content">
                            ...
                            <div class="service-btn">
                                <a href="<?php echo e(route('digital-content-marketing')); ?>"><i class="fas fa-plus"></i> READ MORE</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/local seo 3.png')); ?>" alt="service1">
                        </div>
                        <div class="service-content">
                            ...
                            <div class="service-btn">
                                <a href="<?php echo e(route('local-seo')); ?>"><i class="fas fa-plus"></i> READ MORE</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/social media marketing 1.png')); ?>" alt="service1">
                        </div>
                        <div class="service-content">
                            ...
                            <div class="service-btn">
                                <a href="<?php echo e(route('ecommerce-seo')); ?>"><i class="fas fa-plus"></i> READ MORE</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row carousel">
                <div class="project_list owl-carousel">
                    <div class="col-lg-12 col-md-12">
                        <div class="project-single-box">
                            <div class="project-thumb">
                                <img src="<?php echo e(asset('public/frontend/assets/images/Professional-SEO-Services-1536x1024.jpg')); ?>" alt="project1">
                            </div>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="project-single-box">
                            <div class="project-thumb">
                                <img src="<?php echo e(asset('public/frontend/assets/images/Online-Presence-With-Fast-Gens-Top-PPC-Services-768x512.jpg')); ?>" alt="project1">
                            </div>
                            <div class="project-content">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="project-single-box">
                            <div class="project-thumb">
                                <img src="<?php echo e(asset('public/frontend/assets/images/istockphoto-640174226-170667a-1.jpg')); ?>" alt="project1">
                            </div>
                            <div class="project-content">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="project-single-box">
                            <div class="project-thumb">
                                <img src="<?php echo e(asset('public/frontend/assets/images/e-commerce-seo-768x522.jpg')); ?>" alt="project1">
                            </div>
                            <div class="project-content">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="project-single-box">
                            <div class="project-thumb">
                                <img src="<?php echo e(asset('public/frontend/assets/images/social-media-marketing-article-cover-768x502.webp')); ?>" alt="project1">
                            </div>
                            <div class="project-content">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="project-single-box">
                            <div class="project-thumb">
                                <img src="<?php echo e(asset('public/frontend/assets/images/digital-marketing-2.jpg.optimal-768x521.jpg')); ?>" alt="project1">
                            </div>
                            <div class="project-content">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="project-single-box">
                            <div class="project-thumb">
                                <img src="<?php echo e(asset('public/frontend/assets/images/medium_shot_woman_working_laptop_23_2150323510_0c305232e9-768x512.png')); ?>" alt="project1">
                            </div>
                            <div class="project-content">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="project-single-box">
                            <div class="project-thumb">
                                <img src="<?php echo e(asset('public/frontend/assets/images/istockphoto-1455953950-612x612-1.jpg')); ?>" alt="project1">
                            </div>
                            <div class="project-content">
                    ...
                    <div class="col-lg-12">
                        <div class="brand-box">
                            <div class="brand-thumb">
                                <img src="<?php echo e(asset('public/frontend/assets/images/brand-img.png')); ?>" alt="brand img">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="brand-box">
                            <div class="brand-thumb">
                                <img src="<?php echo e(asset('public/frontend/assets/images/brand-img1.png')); ?>" alt="brand img">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="brand-box">
                            <div class="brand-thumb">
                                <img src="<?php echo e(asset('public/frontend/assets/images/brand-img2.png')); ?>" alt="brand img">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="brand-box">
                            <div class="brand-thumb">
                                <img src="<?php echo e(asset('public/frontend/assets/images/brand-img3.png')); ?>" alt="brand img">
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
                        <div class="brand-box">
                            <div class="brand-thumb">
                                <img src="<?php echo e(asset('public/frontend/assets/images/brand-img4.png')); ?>" alt="brand img">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="working-process-box before-transprent after-transprent">
                        <div class="process-thumb">
                            <img src="<?php echo e(asset('public/frontend/assets/images/home-3/process-1.png')); ?>" alt="img">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="working-process-box after-transprent">
                        <div class="process-thumb">
                            <img src="<?php echo e(asset('public/frontend/assets/images/home-3/process-2.png')); ?>" alt="img">
                            <div class="process-number">
                                <span>02</span>
                            </div>
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="working-process-box before-transprent">
                        <div class="process-thumb">
                            <img src="<?php echo e(asset('public/frontend/assets/images/home-3/process-3.png')); ?>" alt="img">
                            <div class="process-number">
                                <span>03</span>
                            </div>
                        </div>
                    ...
                    <div class="tab_container">
                        ...
                        <div id="tab1" class="tab_content">
                            <ul class="accordion">
                                ...
                                <li>
                                    <a><span>How does IT Care Digital create effective marketing campaigns?</span></a>
                            ...
                            <div class="testi-box">
                                <div class="testi-single-box">
                                    <div class="testi-icon">
                                        <img src="<?php echo e(asset('public/frontend/assets/images/testi1.png')); ?>"
                                            alt="testi1">
                                    </div>
                                    <div class="testi-content">
                                        ...
                                        <h3 class="testi-title">John Miller <span>– CEO, TechWave Solutions</span></h3>
                                    </div>
                                </div>
                                <div class="testi-author">
                                    <img src="<?php echo e(asset('public/frontend/assets/images/testi4.png')); ?>" alt="testi4">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="testi-box">
                                <div class="testi-single-box">
                                    ...
                                    <div class="testi-content">
                                        ...
                                        <h3 class="testi-title">Sarah Thompson <span>– Marketing Manager, BrightVision
                                                Co.</span></h3>
                                    </div>
                                </div>
                                <div class="testi-author">
                                    <img src="<?php echo e(asset('public/frontend/assets/images/testi5.png')); ?>" alt="testi4">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="testi-box">
                                <div class="testi-single-box">
                                    ...
                                    <div class="testi-content">
                                        ...
                                        <h3 class="testi-title">David Lee <span>– Founder, NextGen Startups</span></h3>
                                    </div>
                                </div>
                                <div class="testi-author">
                                    <img src="<?php echo e(asset('public/frontend/assets/images/testi6.png')); ?>" alt="testi4">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="testi-box">
                                ...
                                <div class="testi-author">
                                    <img src="<?php echo e(asset('public/frontend/assets/images/80.jfif')); ?>" alt="testi4">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="testi-box">
                                <div class="testi-single-box">
                                    ...
                                    <div class="testi-content">
                                        ...
                                        <h3 class="testi-title">Michael Scott <span>– Owner, LocalMart Online</span></h3>
                                    </div>
                                </div>
                                <div class="testi-author" style = "border-radius: 50%">
                                    <img src="<?php echo e(asset('public/frontend/assets/images/80 (1).jfif')); ?>" alt="testi4">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-blog-box">
                            <div class="single-blog-thumb">
                                <img src="<?php echo e(asset('public/'. $blog->banner)); ?>" class="img-fluid"
                                    alt="thumb">
                                <div class="blog-meta-top">
                                    <a href="<?php echo e(route('blog')); ?>">UI/UX DESIGNER</a>
                                </div>
                            </div>
                            <div class="blog-box-content">
                                <div class="meta-blog">
                                    <a href="<?php echo e(route('blog')); ?>"><span><i class="far fa-user"></i>HOSSAIN
                                            ASIF</span></a>
                                    <p><span><img
                                                src="<?php echo e(asset('public/frontend/assets/images/home-two/mesage-icon.png')); ?>"
                                                alt="icon"></span>COMMENTS</p>
                                </div>
                                <h3><a href="<?php echo e(route('blog')); ?>"><?php echo e($blog->title); ?>

                                    </a></h3>
                                <div class="blog-button">
                                    <a class="btn-2" href="<?php echo e(route('blog')); ?>">read post</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Neww Xammppp\htdocs\digiitcare_website\resources\views/frontend/index.blade.php ENDPATH**/ ?>