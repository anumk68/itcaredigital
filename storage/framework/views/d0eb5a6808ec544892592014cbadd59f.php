<?php $__env->startSection('title', 'Content Marketing Services in USA | SEO & Content Experts - IT Care Digital'); ?>
<?php $__env->startSection('meta_description',
    'Engage your audience with premium content marketing services in the USA. Combine content
    strategy with SEO for better rankings and conversions.'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="about-us-area">
        <div class="container">
                ...
                <div class="col-lg-6">
                    <div class="about-us-thumb">
                        <div class="about-us-img">
                            <img src="<?php echo e(asset('public/frontend/assets/images/inner/content-marketing-modish-online-business-ecommerce_31965-68123.jpg')); ?>"
            ...
            <div class="about2-us-shape">
                <img src="<?php echo e(asset('public/frontend/assets/images/inner/about-us-sh.png')); ?>" alt="seo and content writing">
            </div>
    ...
    <div class="sservice-area style-two">
        <div class="container">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3 d-flex">
                    <div class="single-service-box">
                        <div class="service-thumb">
                            <img src="<?php echo e(asset('public/frontend/assets/images/inner/content_1.jpg')); ?>"
                                alt="affordable content services">
                        </div>
            ...
            <div class="service-shape bounce-animate3">
                <img src="<?php echo e(asset('public/frontend/assets/images/service5.png')); ?>" alt="content marketing agency usa">
            </div>
            <div class="service-shape2">
                <img src="<?php echo e(asset('public/frontend/assets/images/service7.png')); ?>" alt="affordable content services">
            </div>
            <div class="service-shape3 bounce-animate4">
                <img src="<?php echo e(asset('public/frontend/assets/images/service8.png')); ?>" alt="digital content experts">
            </div>
        </div>
    </div>
    ...
    <div class="faq-area">
        <div class="container">
            ...
            <div class="faq-shape">
                <img src="<?php echo e(asset('public/frontend/assets/images/faq2.png')); ?>" alt="affordable content services">
            </div>
            <div class="faq-shape2">
                <img src="<?php echo e(asset('public/frontend/assets/images/faq3.png')); ?>" alt="digital content experts">
            </div>
        </div>
    </div>
