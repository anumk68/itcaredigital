...
<head>
    ...
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Boost your business with SEO, PPC, web design, social media, and content marketing. IT Care Digital delivers results-driven strategies for growth.'); ?>" />
    ...
    <!-- responsive CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('public/frontend/assets/css/responsive.css')); ?>" type="text/css"
        media="all">
    <!-- modernizr js -->
...
<?php /**PATH C:\xampp\htdocs\itCareDigital_For_SEO_Chnages_From_Mamta\resources\views/frontend/layouts/app.blade.php ENDPATH**/ ?>