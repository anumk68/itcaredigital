<?php $__env->startSection('title', 'Best Digital Marketing & Web Development Agency in USA | IT Care Digital'); ?>
<?php $__env->startSection('meta_description',
    'Partner with the best digital marketing agency in the USA for SEO, web design, and web
    development services that drive growth and leads.'); ?>
<?php $__env->startSection('content'); ?>
            ...
            <div class="row hero align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="hero-thumb">
                        <img src="<?php echo e(asset('public/frontend/assets/images/hero-thumb.png')); ?>"
                ...
                <div class="feature-box">
                    <div class="feature-sinble-single-box">
                        <div class="feature-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/feature1.png')); ?>"
                    ...
                    <div class="feature-sinble-single-box">
                        <div class="feature-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/feature2.png')); ?>"
                    ...
                    <div class="feature-sinble-single-box">
                        <div class="feature-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/feature3.png')); ?>"
                                alt="digital marketing agency usa">
                        </div>
                        <div class="feature-content">
                    ...
                    <div class="feature-sinble-single-box">
                        <div class="feature-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/feature4.png')); ?>"
                                alt="website design and development company">
                        </div>
                        <div class="feature-content">
                    ...
                    <div class="feature-sinble-single-box">
                        <div class="feature-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/feature5.png')); ?>"
                                alt="affordable marketing services usa">
                        </div>
                        <div class="feature-content">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-lg-6">
                    <div class="about-thumb">
                        <img src="<?php echo e(asset('public/frontend/assets/images/about-thumb.png')); ?>"
                            alt="custom seo and web design">
                        <div class="about-shape">
                            <img src="<?php echo e(asset('public/frontend/assets/images/about1.png')); ?>"
                                alt="digital marketing agency usa">
                        </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/service1.png')); ?>"
                                alt="digital marketing agency usa">
                        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/service2.png')); ?>"
                                alt="website design and development company">
                        </div>
                        <div class="service-content">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/service3.png')); ?>"
                                alt="custom seo and web design">
                        </div>
                        <div class="service-content">
                            ...
                            <div class="service-btn">
                                <a href="<?php echo e(route('search-engine-optimization')); ?>"><i class="fas fa-plus"></i> READ
                                    MORE</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/service4.png')); ?>"
                                alt="affordable marketing services usa">
                        </div>
                        <div class="service-content">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/e-commerce seo icon.png')); ?>"
                                alt="digital marketing agency usa">
                        </div>
                        <div class="service-content">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/digital marketing2 (1).png')); ?>"
                                alt="website design and development company">
                        </div>
                        <div class="service-content">
                            ...
                            <div class="service-btn">
                                <a href="<?php echo e(route('digital-content-marketing')); ?>"><i class="fas fa-plus"></i> READ
                                    MORE</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/local seo 3.png')); ?>"
                                alt="custom seo and web design">
                        </div>
                        <div class="service-content">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-3">
                    <div class="service-single-box">
                        <div class="service-icon">
                            <img src="<?php echo e(asset('public/frontend/assets/images/social media marketing 1.png')); ?>"
                                alt="affordable marketing services usa">
                        </div>
                        <div class="service-content">
            ...
            <div class="service-shape bounce-animate3">
                <img src="<?php echo e(asset('public/frontend/assets/images/service5.png')); ?>"
                    alt="website design and development company">
            </div>
            <div class="service-shape2">
                <img src="<?php echo e(asset('public/frontend/assets/images/service7.png')); ?>" alt="digital marketing agency usa">
            </div>
            <div class="service-shape3 bounce-animate4">
                <img src="<?php echo e(asset('public/frontend/assets/images/service8.png')); ?>" alt="custom seo and web design">
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="working-process-box before-transprent after-transprent">
                        <div class="process-thumb">
                            <img src="<?php echo e(asset('public/frontend/assets/images/home-3/process-1.png')); ?>"
                                alt="affordable marketing services usa">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="working-process-box after-transprent">
                        <div class="process-thumb">
                            <img src="<?php echo e(asset('public/frontend/assets/images/home-3/process-2.png')); ?>"
                                alt="custom seo and web design">
                            <div class="process-number">
                                <span>02</span>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="working-process-box before-transprent">
                        <div class="process-thumb">
                            <img src="<?php echo e(asset('public/frontend/assets/images/home-3/process-3.png')); ?>"
                                alt="digital marketing agency usa">
                            <div class="process-number">
                                <span>03</span>
                            </div>
    ...
    <div class="faq-area">
        <div class="container">
            ...
            <div class="faq-shape">
                <img src="<?php echo e(asset('public/frontend/assets/images/faq2.png')); ?>" alt="custom seo and web design">
            </div>
            <div class="faq-shape2">
                <img src="<?php echo e(asset('public/frontend/assets/images/faq3.png')); ?>" alt="affordable marketing services usa">
            </div>
        </div>
    </div>
                    ...
                    <div class="testi_list owl-carousel">
                        <div class="col-lg-12 col-md-12">
                            <div class="testi-box">
                                ...
                                <div class="testi-author">
                                    <img src="<?php echo e(asset('public/frontend/assets/images/testi4.png')); ?>"
                                        alt="affordable marketing services usa">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="testi-box">
                                ...
                                <div class="testi-author">
                                    <img src="<?php echo e(asset('public/frontend/assets/images/testi5.png')); ?>"
                                        alt="affordable marketing services usa">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="testi-box">
                                ...
                                <div class="testi-author">
                                    <img src="<?php echo e(asset('public/frontend/assets/images/testi6.png')); ?>"
                                        alt="digital marketing agency usa">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="testi-box">
                                ...
                                <div class="testi-author">
                                    <img src="<?php echo e(asset('public/frontend/assets/images/80.jfif')); ?>"
                                        alt="affordable marketing services usa">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12 col-md-12">
                            <div class="testi-box">
                                ...
                                <div class="testi-author" style = "border-radius: 50%">
                                    <img src="<?php echo e(asset('public/frontend/assets/images/80 (1).jfif')); ?>"
                                        alt="website design and development company">
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\itCareDigital_For_SEO_Chnages_From_Mamta\resources\views/frontend/index.blade.php ENDPATH**/ ?>